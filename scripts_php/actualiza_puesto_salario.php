...
<body>
   ...
   <div class="container mt-3">
        ...
        <?php
            ...
            print("
                <form action='script_actualizar_puesto_salario.php' method='post' data-aos='fade-up' data-aos-delay='500'>
                    <div class='mb-3 mt-3'>
                        <label class='form-label'>Puesto:</label>
                        <input type='text' class='form-control' pattern='[a-zA-ZñÑáéíóúÁÉÍÓÚ\s]+' name='puesto' value='$puesto'required>
                    </div>
                    <div class='mb-3'>
                        <label class='form-label'>Salario:</label>
                        <input type='number' class='form-control' placeholder='' name='salario' value='$salario' required>
                    </div>
                    <div class='mb-3'>
                        <label class='form-label'>Fecha registrada:</label>
                        <input type='text' class='form-control' name='fecha' value='$fecha' disabled>
                        <label class='form-label'>Actualizar fecha: </label>
