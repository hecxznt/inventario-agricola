...
<body>
   ...
   <div class="container mt-3">
        <h2>Catálogos</h2>
        <h4>Eminación de Cultivos</h4>
        <?php
            $id=$_GET['id'];
            $cultivo=$_GET['cultivo'];

            print("
                <form action='script_eliminar_cultivo.php' method='post' data-aos='fade-up' data-aos-delay='500'>
                    <div class='mb-3 mt-3'>
                        <label class='form-label'>Cultivo:</label>
                        <input type='text' class='form-control' pattern='[a-zA-ZñÑáéíóúÁÉÍÓÚ\s]+' name='cultivo' value='$cultivo'disabled>
                    </div>
                    <div class='mb-3'>
