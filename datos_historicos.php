...
<div class="container">
  <h4 class="text-center">DATOS HISTÓRICOS</h4>
  <p class="text-center">Información estadística que permite la toma de decisiones</p>
  
  <ul class="nav nav-tabs">
    <li class="nav-item">
      <a class="nav-link active" href="bitacoras.php">Bitácoras</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" href="asesorias.php">Asesorías</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" href="residualidad.php">Residualidad</a>
    </li>
  </ul>
  <br>
</div>
